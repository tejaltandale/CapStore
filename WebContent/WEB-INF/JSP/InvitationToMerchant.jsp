...
Enter E-mail of Merchant:<br />
<input type="text" id="sendTo" name = "sendTo" onblur="validateEmail()" /><br />
Subject:<br />
<input type="text" id="subject" name = "subject" value="Invitation to sell your products on our site." /><br />
Message Body: <br />
<textarea rows="4" cols="50" id="msgcontent" name ="msgcontent"></textarea><br />
<input type="submit" value="Send Invitation" onclick="return validateEmail()" />
</form>
      </div>
