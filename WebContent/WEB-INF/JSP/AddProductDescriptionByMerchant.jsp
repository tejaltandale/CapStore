...
<title>Cap Store - Merchant's Product Description</title>
...
<li><a href="discountsbyMerchant">Discounts</a></li>
  ...
  <!--  navigation sidebar starts-->
    <!-- MIDDLE CONTAINER starts here  -->
      <div class="middle-container">Products Added:  
    <form action="fileinsertdescriptionformerchant" method="post" enctype="multipart/form-data">
<p>
Add your product Property:<br/>
