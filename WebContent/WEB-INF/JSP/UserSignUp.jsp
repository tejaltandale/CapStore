...
<!--Search Bar Starts Here-->
	...
	<div class="middle-container">
		<form action="AddUser">
			<table>
				<tr>
					<td>UserId(Ex: C_XXXX)</td>
					<td><input type=text id="n1" name="n1"
						onblur="isProperUserId(this);"></input></td>
				</tr>

				<tr>
					<td>First Name</td>
					<td><input type=text id="n2" name="n2"
						onblur="isProperFirstName(this);"></input></td>
				</tr>

				<tr>
					<td>Last Name</td>
					<td><input type=text id="n3" name="n3"
						onblur="isProperLastName(this);"></input></td>
				</tr>

				<tr>
					<td>Password</td>
					<td><input type=password id="n4" name="n4"
						onblur="isProperPassword(this);"></input></td>
				</tr>

				<tr>
					<td>Email</td>
					<td><input type=text id="n5" name="n5"
						onblur="isProperEmail(this);"></input></td>
				</tr>

				<tr>
					<td>Security Question</td>
					<td><select id="n6" name="n6"><option>What
								is your school name?</option>
							<option>What is your nickname?</option>
							<option>What is your mother's maiden name?</option>
							<option>What is the name of the first company you worked
								for?</option></select></td>
				</tr>

				<tr>
					<td>Answer</td>
					<td><input type=text id="n7" name="n7"
						onblur="isProperAnswer(this);"></input></td>
				</tr>

				<tr>
					<td>Address</td>
					<td><textarea id="n8" name="n8" rows=10 cols=30></textarea></td>
				</tr>

				<tr>
					<td></td>
					<td><input type="submit" value="Submit"
						onclick="return areFieldsBlank()"></input><input type="reset"
						value="Cancel"></input></td>
				</tr>
				<tr>
					<td></td>
					<td>An activation link will be sent to your email on clicking
						submit.Click on it within 24 hrs to activate your account</td>
				</tr>
			</table>
