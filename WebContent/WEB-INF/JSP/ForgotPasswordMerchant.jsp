...
<br/><br/><br/><br/>
<h1>Enter details here to get merchant password</h1>
<form action="submitM" method="get">
Merchant id : <label>${obj.merchantId}</label><input type="text" name="n1" id="n1" value="${obj.merchantId}" style="visibility: hidden;"><br>
Security Question : <label>${obj.merchantSecurityquestion}</label><input type="text" name="n2" id="n2" value="${obj.merchantSecurityquestion}" style="visibility: hidden;"><br>
