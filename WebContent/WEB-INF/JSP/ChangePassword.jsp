...
<div class="middle-container">
	...
	<br />
	<br />
	<h1>Enter details here to change password</h1>
	<form action="change">

		Id<input type="text" name="n1" id="n1" onblur="return isID(this)" /><br />
		Old Password<input type="password" name="n2" id="n2" /><br /> New
		Password<input type="password" name="n3" id="n3"
			onblur="return same()" /><br /> Confirm Password<input
			type="password" name="n4" id="n4" onblur="return valid()" /> <br /> <input
			type="submit" name="submit" value="Change Password"
			onclick="return blank()" />
	</form>
